...
cur = conn.cursor()
sql = "select embers_id,stock_index,date,last_price,one_day_change from t_daily_stockindex where date>='2012-01-01' order by date asc"
...
with open("d:/embers/historical_stock_2012-01-01.json","w") as out:
