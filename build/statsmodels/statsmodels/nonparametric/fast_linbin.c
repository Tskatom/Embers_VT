/* Generated by Cython 0.15.1 on Mon Jul 16 12:58:13 2012 */
...
/* "statsmodels\nonparametric\fast_linbin.pyx":11
 * import numpy as np
 * 
...
/* "statsmodels\nonparametric\fast_linbin.pyx":12
 * 
 * ctypedef np.float64_t DOUBLE
 * ctypedef np.int_t INT             # <<<<<<<<<<<<<<
 * 
...
/* "statsmodels\nonparametric\fast_linbin.pyx":17
...
static PyObject *__pyx_pf_11statsmodels_13nonparametric_11fast_linbin_linbin(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":23
 *     cdef:
 *         Py_ssize_t i, li_i
 *         int nobs = X.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":24
 *         Py_ssize_t i, li_i
 *         int nobs = X.shape[0]
 *         double delta = (b - a)/(M - 1)             # <<<<<<<<<<<<<<
 *         np.ndarray[DOUBLE] gcnts = np.zeros(M, np.float)
 ...
 */
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":25
 *         int nobs = X.shape[0]
 *         double delta = (b - a)/(M - 1)
 *         np.ndarray[DOUBLE] gcnts = np.zeros(M, np.float)             # <<<<<<<<<<<<<<
 *         np.ndarray[DOUBLE] lxi = (X - a)/delta
 ...
 */
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":26
 *         double delta = (b - a)/(M - 1)
 *         np.ndarray[DOUBLE] gcnts = np.zeros(M, np.float)
 *         np.ndarray[DOUBLE] lxi = (X - a)/delta             # <<<<<<<<<<<<<<
 *         np.ndarray[INT] li = lxi.astype(int)
 ...
 */
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":27
 *         np.ndarray[DOUBLE] gcnts = np.zeros(M, np.float)
 *         np.ndarray[DOUBLE] lxi = (X - a)/delta
 *         np.ndarray[INT] li = lxi.astype(int)             # <<<<<<<<<<<<<<
 *         np.ndarray[DOUBLE] rem = lxi - li
 ...
 */
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":28
 *         np.ndarray[DOUBLE] lxi = (X - a)/delta
 *         np.ndarray[INT] li = lxi.astype(int)
 *         np.ndarray[DOUBLE] rem = lxi - li             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":31
 * 
 * 
 *     for i in range(nobs):             # <<<<<<<<<<<<<<
 *         li_i = li[i]
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "statsmodels\nonparametric\fast_linbin.pyx":32
 * 
 *     for i in range(nobs):
 *         li_i = li[i]             # <<<<<<<<<<<<<<
 *         if li_i > 1 and li_i < M:
 ...
 */
    ...
    /* "statsmodels\nonparametric\fast_linbin.pyx":33
 *     for i in range(nobs):
 *         li_i = li[i]
 *         if li_i > 1 and li_i < M:             # <<<<<<<<<<<<<<
 *             gcnts[li_i] = gcnts[li_i] + 1 - rem[i]
 ...
 */
    ...
    if (__pyx_t_14) {
      ...
      /* "statsmodels\nonparametric\fast_linbin.pyx":34
 *         li_i = li[i]
 *         if li_i > 1 and li_i < M:
 *             gcnts[li_i] = gcnts[li_i] + 1 - rem[i]             # <<<<<<<<<<<<<<
 *             gcnts[li_i+1] = gcnts[li_i+1] + rem[i]
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_11statsmodels_13nonparametric_11fast_linbin_DOUBLE *, __pyx_bstruct_gcnts.buf, __pyx_t_17, __pyx_bstride_0_gcnts) = (((*__Pyx_BufPtrStrided1d(__pyx_t_11statsmodels_13nonparametric_11fast_linbin_DOUBLE *, __pyx_bstruct_gcnts.buf, __pyx_t_15, __pyx_bstride_0_gcnts)) + 1.0) - (*__Pyx_BufPtrStrided1d(__pyx_t_11statsmodels_13nonparametric_11fast_linbin_DOUBLE *, __pyx_bstruct_rem.buf, __pyx_t_16, __pyx_bstride_0_rem)));
      ...
      /* "statsmodels\nonparametric\fast_linbin.pyx":35
 *         if li_i > 1 and li_i < M:
 *             gcnts[li_i] = gcnts[li_i] + 1 - rem[i]
 *             gcnts[li_i+1] = gcnts[li_i+1] + rem[i]             # <<<<<<<<<<<<<<
 *         if li_i > M and trunc == 0:
 ...
 */
    ...
    /* "statsmodels\nonparametric\fast_linbin.pyx":36
 *             gcnts[li_i] = gcnts[li_i] + 1 - rem[i]
 *             gcnts[li_i+1] = gcnts[li_i+1] + rem[i]
 *         if li_i > M and trunc == 0:             # <<<<<<<<<<<<<<
 *             gcnts[M] = gcnts[M] + 1
 ...
 */
    ...
    if (__pyx_t_13) {
      ...
      /* "statsmodels\nonparametric\fast_linbin.pyx":37
 *             gcnts[li_i+1] = gcnts[li_i+1] + rem[i]
 *         if li_i > M and trunc == 0:
 *             gcnts[M] = gcnts[M] + 1             # <<<<<<<<<<<<<<
 *     return gcnts
 */
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":38
 *         if li_i > M and trunc == 0:
 *             gcnts[M] = gcnts[M] + 1
 *     return gcnts             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":9
 * cimport cython
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "statsmodels\nonparametric\fast_linbin.pyx":1
 * #cython profile=True             # <<<<<<<<<<<<<<
 * """
 * cython -a fast_linbin.pyx
 */
